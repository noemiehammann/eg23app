...
public class GestionDuSemestreEnCours extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gestion_du_semestre_en_cours);
        ...
        ouverturebutton3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) { // fonction déclenchée sur le clic du bouton
                Intent intent = new Intent(GestionDuSemestreEnCours.this, Gestion2.class);
        ...
        //ouverture 3ème diagramme diagramme
        final Button ouverturebutton5= (Button) findViewById(R.id.buttondiagramme5);
        // Création d’un évènement qui attend un clic sur le bouton
        ouverturebutton5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { // fonction déclenchée sur le clic du bouton
                Intent intent = new Intent(GestionDuSemestreEnCours.this, Gestion2.class);
                // Exécution de l’activité : ouverture de la fenêtre
